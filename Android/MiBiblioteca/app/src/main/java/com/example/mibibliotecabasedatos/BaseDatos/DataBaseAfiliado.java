...
public class DataBaseAfiliado extends DataBaseAccess {
    ...
    private static String[] allcolumns={Afiliado.COLUMNA_ID,Afiliado.COLUMNA_NOMBRE,Afiliado.COLUMNA_CIUDAD,Afiliado.COLUMNA_DIRECCION,
    Afiliado.COLUMNA_SEXO,Afiliado.COLUMNA_TELEFONO,Afiliado.COLUMNA_ESTADO}; // vector con la información de campos para afiliados
